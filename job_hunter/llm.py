...
_SCORE_SCAFFOLD = (
    ...
    "target grade above. "
    "Also STRONG FIT: roles where the candidate's value is EVALUATING THE APPROACH "
    "and making architectural decisions (which method to use: RAG / fine-tune / "
    "rules / automation / human-in-the-loop), even if writing code is delegated to "
    "a team or AI tools. Example titles: AI Solutions Engineer (product/internal, "
    "NOT sales-facing), AI Enablement Engineer, AI Transformation Engineer, "
    "Founding/Staff AI Engineer with architectural focus. Judge by the substance "
    "of the responsibilities, not the title.\n"
